...
if($("#i4 .sn div span:last-of-type").html() == $("#i4 .sn div span:first-of-type").html()){
    ...
    $(document).on("click","#i3 a",function(){
        $("#i3 a").prop('onclick',null).off('click').attr("href",backToGallery);
	});
}
